...
contract Create {
    ...
    function setCandidate(
        ...
        require(votingOrganizer == msg.sender, "Only organizer can access");
        _candidateId++;
    ...
    function voterRight(
        ...
        require(
            votingOrganizer == msg.sender,
            "Only Organizer can create vote"
        );
        ...
        require(voter.voter_allowed == 0, "Already Register for Vote");
